...
public class FormEditTrainNumber : OptionOrInputDialogue
{
    public FormEditTrainNumber() : base("formEditTrainNumber")
    {
    ...
    public override State State => State.FormEditTrainNumber;
